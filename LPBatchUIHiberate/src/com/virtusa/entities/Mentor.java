...
/**
 * 
 * MENTOR_ID NOT NULL NUMBER(10) FIRST_NAME NOT NULL VARCHAR2(20) LAST_NAME NOT NULL
...
public class Mentor {
	...
	public String toString() {
		return "Mentor [mentorId=" + mentorId + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email
				+ ", phoneNumber=" + phoneNumber + ", role=" + role + ", city=" + city + ", state=" + state
				+ ", country=" + country + ", batchId=" + batchId + "]";
	}
